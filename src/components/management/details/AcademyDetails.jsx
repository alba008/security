...
export default function AcademyDetails({ record, statuses, updateRecord }) {
  return (
    <Box sx={wrap}>
      <Typography sx={sectionTitle}>Academy Lead Details</Typography>

      <Info label="Full Name" value={record.full_name} />
      <Info label="Email" value={record.email} />
      <Info label="Phone" value={record.phone} />
      <Info label="Course Interest" value={record.course_interest} />
